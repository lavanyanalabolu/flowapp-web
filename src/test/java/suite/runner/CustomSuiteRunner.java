...
public class CustomSuiteRunner {
	...
	public static void suiteRunner() {
		 ...
		 * 		 
		 * 
		 *  2.	Go to Control Sheet Read Suite Name and Information required to run suite -:
	...
	public Iterator<Object[]> getExcelTestData() 
	{
		...
		final LinkedList<Object[]> dataBeans = excelReader.getRowDataMap("C:\\Framework\\src\\test\\resources\\ExcelFiles\\FlowTestData.xlsx","Credentials");
